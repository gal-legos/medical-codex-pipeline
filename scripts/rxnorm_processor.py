...
df = df.drop(['aui', 'archive_timestamp', 'created_timestamp', 
                      'code', 'is_brand', 'lat', 'last_released', 
                      'saui', 'vsab', 'rxcui', 'sab', 'tty', 
                      'merged_to_rxcui'])

df = df.rename({'rxaui': 'code', 'str': 'description', 
                        'updated_timestamp': 'last_updated'})
